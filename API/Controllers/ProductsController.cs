...
namespace API.Controllers
{
    ...
    public class ProductsController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Product>> CreateProduct([FromForm] CreateProduct createProduct)
        {
            ...
            if (createProduct.File != null)
            {
                ...
                if (imageResult.Error != null) return
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut]
        public async Task<ActionResult<Product>> UpdateProduct([FromForm] UpdateProduct updateProduct)
        {
